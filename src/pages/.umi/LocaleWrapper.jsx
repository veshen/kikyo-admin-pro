...
const localeInfo = {
  'en-US': {
    messages: require('/Users/wangwei/Documents/多看/my-project/src/locales/en-US.js').default,
    locale: 'en-US',
    antd: require('antd/lib/locale-provider/en_US'),
    data: require('react-intl/locale-data/en'),
  },
  'zh-CN': {
    messages: require('/Users/wangwei/Documents/多看/my-project/src/locales/zh-CN.js').default,
    locale: 'zh-CN',

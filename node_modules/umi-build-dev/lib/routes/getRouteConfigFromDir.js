...
function getRouteConfigFromDir(paths) {
  ...
  if (dirPath === '' && absSrcPath) {
    const globalLayoutFile = findJSFile(absSrcPath, 'layouts/index') || findJSFile(absSrcPath, 'layout/index');
...
function handleFile(paths, absPath, memo, file) {
  ...
  if (stats.isDirectory()) {
    ...
    const absLayoutFile = findJSFile((0, _path.join)(absPagesPath, newDirPath), '_layout');

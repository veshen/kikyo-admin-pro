...
class PluginAPI {
  ...
  _addMethods() {
    ...
    [['chainWebpackConfig', {
      ...
      type: this.API_TYPE.ADD
    }], 'onStart', 'onDevCompileDone', 'onBuildSuccess', 'onBuildFail', 'addPageWatcher', 'addEntryCode', 'addEntryCodeAhead', 'addEntryImport', 'addEntryImportAhead', 'addEntryPolyfillImports', 'addRendererWrapperWithComponent', 'addRendererWrapperWithModule', 'addRouterImport', 'addRouterImportAhead', 'addVersionInfo', 'modifyAFWebpackOpts', 'modifyEntryRender', 'modifyEntryHistory', 'modifyRouteComponent', 'modifyRouterRootComponent', '_beforeServerWithApp', 'beforeDevServer', '_beforeDevServerAsync', 'afterDevServer', 'addMiddlewareAhead', 'addMiddleware', 'addMiddlewareBeforeMock', 'addMiddlewareAfterMock', 'modifyRoutes', 'onPatchRoute', 'modifyHTMLContext', 'addHTMLMeta', 'addHTMLLink', 'addHTMLScript', 'addHTMLStyle', 'addHTMLHeadScript', 'onGenerateFiles', 'onHTMLRebuild', 'modifyDefaultConfig', '_modifyConfig', 'modifyHTMLWithAST', '_modifyHelpInfo'].forEach(method => {
  ...
  registerGenerator(name, opts) {
    ...
    (0, _assert.default)(opts && opts.Generator, `opts.Generator should be supplied`); // assert(
  ...
  registerPlugin(opts) {
    (0, _assert.default)((0, _isPlainObject.default)(opts), `opts should be plain object, but got ${opts}`);
    const id = opts.id,
          apply = opts.apply;
